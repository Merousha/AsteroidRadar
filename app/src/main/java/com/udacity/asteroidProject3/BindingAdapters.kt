package com.udacity.asteroidProject3
...
import com.udacity.asteroidProject3.main.AsteroidAdapter
...
fun bindRecyclerView(recyclerView: RecyclerView, asteroidList: List<Asteroid>?){
    val adapter: AsteroidAdapter = recyclerView.adapter as AsteroidAdapter
